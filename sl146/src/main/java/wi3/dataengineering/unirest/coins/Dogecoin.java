...
public class Dogecoin implements CoinsInterface{
    ...
    public Dogecoin(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "Dogecoin [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
