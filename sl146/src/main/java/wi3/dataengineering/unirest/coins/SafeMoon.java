 ...
 */
public class SafeMoon implements CoinsInterface{
    ...
    public SafeMoon(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "SafeMoon [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
