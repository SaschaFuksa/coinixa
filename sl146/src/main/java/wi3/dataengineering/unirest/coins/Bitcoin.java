 ...
 */
public class Bitcoin implements CoinsInterface{
    ...
    public Bitcoin(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "Bitcoin [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
