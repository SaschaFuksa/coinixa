 ...
 */
public class Cardano implements CoinsInterface{
    ...
    public Cardano(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "Cardano [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
