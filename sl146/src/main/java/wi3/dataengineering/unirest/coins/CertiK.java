 ...
 */
public class CertiK implements CoinsInterface{
    ...
    public CertiK(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "CertiK [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
