 ...
 */
public class Tezos implements CoinsInterface{
    ...
    public Tezos(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "Tezos [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
