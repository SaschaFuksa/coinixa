 ...
 */
public class Ethereum implements CoinsInterface{
    ...
    public Ethereum(String symbol, float priceChange, float priceChangePercent, float prevClosePrice, float lastPrice,
    ...
    public String toString() {
        return "Ethereum [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
