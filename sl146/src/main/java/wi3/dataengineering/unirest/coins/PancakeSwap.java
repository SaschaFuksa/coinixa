...
public class PancakeSwap implements CoinsInterface{
    ...
    public PancakeSwap(String symbol, float priceChange, float priceChangePercent, float prevClosePrice,
            float lastPrice, float openPrice, float highPrice, float volume) {
        this.symbol = symbol;
    ...
    public String toString() {
        return "PancakeSwap [highPrice=" + highPrice + ", lastPrice=" + lastPrice + ", openPrice=" + openPrice
